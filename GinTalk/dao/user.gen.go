...
type user struct {
	...
	ALL        field.Asterisk
	ID         field.Int64  // 自增主键，唯一标识用户记录
	UserID     field.Int64  // 用户ID，用于业务中的用户唯一标识
	Username   field.String // 用户名，唯一且不区分大小写
	Password   field.String // 用户密码，存储的是哈希值
	Email      field.String // 用户邮箱，可为空
